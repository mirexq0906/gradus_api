...
const ProductAdmin = () => {
  ...
  async function deleteProduct(productId) {
    await axios.delete(process.env.REACT_APP_SERVER + "products/" + productId);
              ...
              <tr key={item.id}>
                ...
                <td className="table-admin__body-buttons">
                  <div className="table-admin__row-buttons">
                    <button onClick={() => deleteProduct(item.url)} className="btn table-admin__delete">
                      <svg
                    ...
                    <button onClick={() => router(`/admin/product/update/${item.url}`) } className="btn table-admin__update">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                    ...
                    <button onClick={() => router(`/admin/product/view/${item.url}`) } className="btn table-admin__view">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
