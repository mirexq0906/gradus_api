...
const SubCategoryAdmin = () => {
  ...
  async function deleteSubCategory(subCategoryId) {
    await axios.delete(process.env.REACT_APP_SERVER + "sub_categories/" + subCategoryId);
  ...
  return (
    <section className="admin-watch">
      <div className="container">
        ...
        <Link to="/admin/subcategory/add" className="btn-admin">
              ...
              <tr key={item.id}>
                ...
                <td className="table-admin__body-buttons">
                  <div className="table-admin__row-buttons">
                    <button
                      onClick={() => deleteSubCategory(item.url)}
                    ...
                    <button
                      onClick={() =>
                        router(`/admin/subcategory/update/${item.url}`)
                      }
                      className="btn table-admin__update"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <button
                      onClick={() =>
                        router(`/admin/subcategory/view/${item.url}`)
                      }
