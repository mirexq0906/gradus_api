...
import { fetchEmails } from "../../../API/FeedbackService";
...
const EmailAdmin = () => {
  ...
  async function deleteEmail(id) {
    await axios.delete(process.env.REACT_APP_SERVER + 'email_clients/' + id);
              ...
              <tr key={item.id}>
                ...
                <td className="table-admin__body-buttons">
                  <div className="table-admin__row-buttons">
                    <button onClick={() => deleteEmail(item.id)} className="btn table-admin__delete">
                      <svg
